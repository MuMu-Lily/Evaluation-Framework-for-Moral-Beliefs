#已经评价过的模型：gemini（自己）、gpt35、chatglm、erine
import sys
...
def debate(topic):
    ...
    Answer_O_r1 = erniebot.getresponse(hB)
    ...
    # print("hB2", hB)
    Answer_O_r2 = erniebot.getresponse(hB)
...
if __name__ == "__main__":
    ...
    file_write = "D:\VScode\lxl\Debate\\results\dilemma_debate_getoer.csv"
    file_history = "D:\VScode\lxl\Debate\\results\dilemma_debate_getoer_history.json"
