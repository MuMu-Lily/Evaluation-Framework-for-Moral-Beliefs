#已经评价过的模型：erine（自己）、gemini、gpt35、chatglm
import sys
...
def debate(topic):
    ...
    Answer_A_r1 = erniebot.getresponse(hA)
    ...
    Answer_O_r1 = chatglm6b.getresponse(hB)
    ...
    Answer_A_r2 = erniebot.getresponse(hA)
    ...
    # print("hB2", hB)
    Answer_O_r2 = chatglm6b.getresponse(hB)
    ...
    Answer_A_r3 = erniebot.getresponse(hA)
...
if __name__ == "__main__":
    ...
    file_write = "D:\VScode\lxl\Debate\\results\dilemma_debate_ertoch.csv"
    file_history = "D:\VScode\lxl\Debate\\results\dilemma_debate_ertoch_history.json"
